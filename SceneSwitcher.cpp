...
static OffscreenTarget gOffscreenTargets[3];
static VkRenderPass    gOffscreenRenderPass = VK_NULL_HANDLE;
static VkSampler       gOffscreenSampler     = VK_NULL_HANDLE;
static GlobalContext_Switcher::UniformData gCompositeUniformData;
static VkDescriptorSet gCompositeDescriptorSet_array[3] =
{
    VK_NULL_HANDLE,
    VK_NULL_HANDLE,
    VK_NULL_HANDLE
...
static VkResult CreateCompositeUniformBuffer(void)
{
    ...
    bufferInfo.size  = sizeof(GlobalContext_Switcher::MyUniformData);
    ...
    GlobalContext_Switcher::MyUniformData data;
...
static void UpdateCompositeDescriptorSets(void)
{
    ...
    bufferInfo.range = sizeof(GlobalContext_Switcher::MyUniformData);
...
VkResult vkResult = VK_SUCCESS;
    ...
    VkCommandBuffer submitBuffers[4];
...
VkResult createDescriptorPool(void)
{
    ...
    vkDescriptorPoolCreateInfo.maxSets = 6;
...
VkResult buildCommandBuffers(void)
{
    ...
    for (uint32_t i = 0; i < gCtx_Switcher.swapchainImageCount; ++i)
    {
        VkCommandBuffer sceneBuffers[3] =
        {
        ...
        float baseBlend[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
        ...
        if (drawBaseScene && gActiveScene != ACTIVE_SCENE_SCENE0 && transition < 1.0f)
        {
            drawBaseScene = FALSE;
        }
